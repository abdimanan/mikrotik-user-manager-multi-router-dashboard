...
import { Download, ShieldCheck, Database, Sliders, Users2, ScrollText } from 'lucide-react';
import { api } from '../api';
        ...
        {(canManageAccounts || isSuperAdmin) && (
          <>
            ...
            {canManageAccounts && (
              ...
              >
                <Users2 className="w-[20px] h-[20px] mr-3" />
                <span>Accounts</span>
              </button>
            )}
            ...
            {isSuperAdmin && (
              ...
              >
                <ScrollText className="w-[20px] h-[20px] mr-3" />
